...
'''
描述: 以天创api的个人身份验证作为示例, 具体接口请根据贵公司所购买接口的接口文档的相关参数进行修改
作者：宾毅
日期: 2018年08月24号
'''
# 接口地址，具体接口参见接口文档，每个接口有不同的url地址
url = "http://api.tcredit.com/integration/creditProbe01"
...
if __name__ == "__main__":
    ...
    params = {'tokenKey': tokenKey, 'appId': appId, 'name': name, 'idCard': idcard, 'mobile': mobile}
    print('请求参数', params)
    # 发送请求
